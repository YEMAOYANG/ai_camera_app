        ...
        observation = normalize_vision_observation(
            {
                ...
                "toys_on_table": bool(parsed.get("toys_on_table")),
                "meal_standing": bool(parsed.get("meal_standing")),
                "play_safety_status": parsed.get("play_safety_status"),
                "play_safety_reason": parsed.get("play_safety_reason"),
                "homework_like": bool(parsed.get("homework_like")),
                "child_message": child_message,
                "screen_device_visible": parsed.get("screen_device_visible"),
                "screen_device_type": parsed.get("screen_device_type"),
                "screen_use_active": parsed.get("screen_use_active"),
                "screen_distance_risk": parsed.get("screen_distance_risk"),
                "screen_use_context": parsed.get("screen_use_context"),
                "screen_use_duration_hint": parsed.get("screen_use_duration_hint"),
            },
            observed_at=observed_at,
            method=method,
        )
