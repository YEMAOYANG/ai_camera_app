...
class TaskService:
    ...
    def create_task(self, access_token: str, data: dict) -> dict:
        ...
        task_type = validate_task_type(self._optional_text(data, "type") or "learning")
        scheduled_date = self._optional_text(data, "scheduledDate") or date.today().isoformat()
        ...
        with self.repository.transaction() as conn:
            ...
            task = self.repository.create_task(
                ...
                task_type=task_type,
                scheduled_date=scheduled_date,
                scheduled_start=self._optional_text(data, "scheduledStart"),
                scheduled_end=self._optional_text(data, "scheduledEnd"),
