...
const setupCameraNamePath = '/setup/camera-name';
const setupEmergencyContactsPath = '/setup/emergency-contacts';
const addCameraPath = '/devices/add-camera';
...
const profileReportsHubPath = '/profile/reports';
...
const profileStudentAccessPath = '/profile/child/student-access';
const studentAccessQrPath = '/student-access/scan';
...
const profileCareCapabilitiesPath = '/profile/care-capabilities';
const profileRoutineWindowsPath = '/profile/routine-windows';
